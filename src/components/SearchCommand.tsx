...
const SearchCommand = () => {
  ...
  const searchData = [
    ...
    // Shoulder & Elbow
    { category: "Shoulder & Elbow", title: "Rotator Cuff Repair", route: "/rotator-cuff-repair" },
    { category: "Shoulder & Elbow", title: "Massive Rotator Cuff Repair", route: "/massive-rotator-cuff-repair" },
    { category: "Shoulder & Elbow", title: "Rotator Cuff Reconstruction", route: "/rotator-cuff-reconstruction" },
    { category: "Shoulder & Elbow", title: "Bankart Repair", route: "/bankart-repair" },
